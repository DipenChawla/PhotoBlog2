...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_email_field = findViewById(R.id.reg_email_text);
        reg_pass_field = findViewById(R.id.reg_password);
        reg_confirm_pass_field = findViewById(R.id.confirm_passwd);
        reg_btn = findViewById(R.id.register_btn);
        reg_login_btn = findViewById(R.id.login_redirect_btn);
