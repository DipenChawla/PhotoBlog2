...
public class BlogRecyclerAdapter extends RecyclerView.Adapter<BlogRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        try {
            ...
            String dateString = DateFormat.format("dd/MM/yyyy", new Date
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setBlogImage(String downloadUri, String thumbUri) {
            ...
            Glide.with(context).applyDefaultRequestOptions(requestOptions).load
                    (downloadUri).thumbnail(
        ...
        public void setUserData(String name, String image) {
            ...
            Glide.with(context).applyDefaultRequestOptions(placeholderOption).load
                    (image).into(blogUserImage);
